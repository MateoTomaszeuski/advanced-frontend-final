    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <svg
            className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-theme-text"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          {value && onClear && (
            <button
              type="button"
              onClick={onClear}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-theme-text hover:text-theme-accent"
            >
