  ...
  return (
    <div className="mt-8">
      <div className="flex items-center justify-between mb-4">
        ...
        {isLoading && (
          <div className="animate-spin h-5 w-5 border-2 border-theme-accent border-t-transparent rounded-full"></div>
        )}
      </div>
      <div className="space-y-3">
        {playlists.map((playlist) => (
          <div
            key={playlist.id}
            className="bg-theme-card rounded-lg shadow-sm border border-theme-border p-4 hover:border-theme-accent transition-colors"
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <a
                ...
                rel="noopener noreferrer"
                  className="shrink-0 inline-flex items-center px-4 py-2 text-sm font-medium text-theme-accent bg-theme-background hover:bg-theme-accent hover:text-theme-background rounded-md transition-colors"
              >
