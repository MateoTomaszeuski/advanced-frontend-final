            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <a
                ...
                rel="noopener noreferrer"
                  className="shrink-0 inline-flex items-center px-4 py-2 text-sm font-medium text-theme-accent bg-theme-background hover:bg-theme-accent hover:text-theme-text rounded-md transition-colors"
              >
